...
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 1.0.0 --to prod
~/pact-broker-1.47.0/bin/pact-broker create-version-tag -a de.tine.bar -e 10.0.0 -t prod
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 1.0.0 --to prod

cd ../provider-baz
../mvnw clean verify -Dpact.provider.version=20.0.0 -Dpact.verifier.publishResults=true
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 1.0.0 --to prod
~/pact-broker-1.47.0/bin/pact-broker create-version-tag -a de.tine.baz -e 20.0.0 -t prod
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 1.0.0 --to prod
...
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 2.0.0 --to prod
~/pact-broker-1.47.0/bin/pact-broker create-version-tag -a de.tine.bar -e 11.0.0 -t prod
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 2.0.0 --to prod
...
~/pact-broker-1.47.0/bin/pact-broker can-i-deploy -a de.tine.foo -e 3.0.0 --to prod
